...
namespace ModeloDeDados.Migrations
{
    ...
    [Migration("20190621204356_Faturamento")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModeloDeDados.Classes.Agendamento", b =>
                {
                    ...
                    b.Property<string>("HorarioConsuta")
                        .HasMaxLength(20);
            ...
            modelBuilder.Entity("ModeloDeDados.Classes.ContasPagar", b =>
                {
            ...
            modelBuilder.Entity("ModeloDeDados.Classes.ContasReceber", b =>
                {
            ...
            modelBuilder.Entity("ModeloDeDados.Classes.Faturamento", b =>
                {
            ...
            modelBuilder.Entity("ModeloDeDados.Classes.Usuario", b =>
                {
            ...
            modelBuilder.Entity("ModeloDeDados.Classes.Agendamento", b =>
                {
                    b.HasOne("ModeloDeDados.Classes.Medico", "Medico")
                    ...
                    b.HasOne("ModeloDeDados.Classes.Plano", "Plano")
                        .WithMany("Agendamentos")
